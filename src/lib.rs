...
pub use model_package::{
    ...
    BurnJepaModelProfile, BurnJepaPackageModelKind, BurnJepaPipelinePackageManifest,
    ...
    DEFAULT_BURNPACK_SHARD_MAX_BYTES, apply_burnpack_parts, burn_jepa_model_profile_base_url,
    burnpack_dtype_counts, burnpack_parts_dtype_counts, burnpack_parts_manifest_path,
...
pub use viewer::{
    ...
    PIPELINE_IMAGE_SIZE_MULTIPLE, PatchDiffRefreshConfig, PatchDiffRefreshState,
    RgbaPatchDiffFrameStats, bucket_sparse_mask, center_prior_mask, finalize_patch_diff_mask,
