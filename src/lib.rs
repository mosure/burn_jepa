...
pub use training::{
    ...
    TttDistillationConfig, TttDistillationLoss, TttDomainEvalMetric, TttEvalModelKind,
    TttEvalReport, TttLatentRegularizationConfig, TttLatentRegularizationMetrics,
