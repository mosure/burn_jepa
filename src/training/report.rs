...
pub struct TttMemoryMetrics {
    ...
    pub pretrained_train_scope: crate::TttPretrainedTrainScope,
    ...
    pub ttt_trainable_param_elements: usize,
    pub pretrained_trainable_param_elements: usize,
...
pub struct TttTargetSupervisionMetrics {
    ...
    pub rolling_teacher_window_frames: usize,
