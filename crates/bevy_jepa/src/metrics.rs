...
pub struct BevyJepaMetrics {
    ...
    pub reconstruction_decode_us: u64,
    pub reconstruction_psnr_db: Option<f64>,
    ...
    pub reconstruction_frames: u64,
    pub pca_update_events: u64,
    pub input_fps: f64,
    pub low_res_fps: f64,
    pub high_res_fps: f64,
    pub reconstruction_fps: f64,
    pub pca_update_fps: f64,
...
pub(super) fn bevy_metrics_from_stage(
    ...
    BevyJepaMetrics {
        ...
        pca_update_events: u64::from(stage_metrics.pca_update_applied),
        input_fps: 0.0,
        low_res_fps: 0.0,
        high_res_fps: 0.0,
        reconstruction_fps: 0.0,
        pca_update_fps: 0.0,
        in_flight_frames: 0,
